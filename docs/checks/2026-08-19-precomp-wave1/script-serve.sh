...
# setsid/nohup do not survive on this machine). Same pinned binary/flags as the
# flown P-ATTR / P-PROMPT meeting flights: -c 49152 -np 1 -fa on -ngl 999 -ctk q8_0 -ctv q8_0.
set -euo pipefail
