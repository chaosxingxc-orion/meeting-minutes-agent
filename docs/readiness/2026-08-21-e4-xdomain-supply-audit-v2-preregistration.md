...
The audit asks whether a new business-domain surface has enough upstream-labelled, speaker-exclusive professional-entity recurrence to replace Product/AMI in later design work. It uses only `transcripts/nlp_references/*.nlp` from Rev's Earnings-22 commit `c05ab6fd8b4b627d123c922a22a39e993dd37635`. The text acquisition was independently verified as 422 Git blobs with zero mismatch; the audit expects exactly 125 NLP references and no audio.
